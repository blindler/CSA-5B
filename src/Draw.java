public class Draw {// from Unit 03 FRQ Progress Check, Q2


    /** Precondition: All parameters are between 0 and 10, inclusive.
     * Draws a line segment in a -xy- -coordinate grid.
     ...
     * Draws a square on a -xy- -coordinate grid
    ...
    public void drawSquare(int x, int y, int len) {
        ...
        if (y - len < 0) len = y; // len = 2

        if ( x + len > 10 ) len = 10-x;

        System.out.println( "len is: " + len + " area is: " + (len*len));
